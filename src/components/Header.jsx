...
export const Header = () => {
  ...
  const handleSubmit = (e) => {
    ...
    e.target.reset();
    return redirect(`/search?q=${queryTerm}`);
  };
  return (
    <header>
      <nav className="bg-custom-bg border-b-2 border-gray-300 px-2 sm:px-4 py-2.5 dark:bg-dark-bg dark:border-b-2 dark:border-blue-100">
