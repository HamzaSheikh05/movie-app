...
export const Footer = () => {
  return (
    <footer className="p-4 font-burtons bg-custom-bg shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-dark-bg">
      <span className="text-sm text-gray-500 sm:text-center dark:text-blue-200">
        <Link to="/" className="hover:underline">
          DevelopedByHS
        </Link>{" "}
        Copyrights Reserved 2023
      </span>
      <ul className="flex flex-wrap items-center mt-3 text-sm text-gray-500 dark:text-blue-200 sm:mt-0">
        <li>
          <a
